...
if(isset($_GET['tgl1'])  && isset($_GET['tgl2']) && !empty($_GET['tgl1']) && !empty($_GET['tgl2'])){
    $tgl1 = $_GET['tgl1'];
    $tgl2 = $_GET['tgl2'];
    $daftartransaksi = query("SELECT * FROM barang_masuk WHERE tgl_trans_masuk BETWEEN '$tgl1' AND '$tgl2'");
    ...
    <div id="wrapper">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <br>
                                    <a href="9-Dashboard-BarangMasuk-transaksi.php" class="btn btn-primary"> <i class="fas fa-plus"></i> Tambah Data</a>
                                    ...
                                    <table id="table_barang" class="display">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($daftartransaksi as $daftar): ?>
                                                <tr>
                                                    <td><?= $i ?></td>
                                                    <td><?= $daftar['kode_trans_masuk'] ?></td>
                                                    <td><?= $daftar['tgl_trans_masuk'] ?></td>
                                                    <td><?= number_format($daftar['grand_total'],0,',','.')  ?></td>
                                                    <td><button onclick="return cetak('barang_masuk','<?= $daftar['kode_trans_masuk'] ?>')">cetak</button></td>
                                                </tr>
                                                <?php $i++; ?>
                                            <?php endforeach ?>
                                        </tbody>
        ...
        <script>
            ...
            function cetak(tb,id){
                window.open("cetak.php?tb="+tb+"&id="+id,"Cetak Transaksi", "width=450,height=600")
            }
